 ...
 window.hugrid = {
  ...
  makehugrid = function () {
    ...
    if (typeof window.pageleftmargin === 'number') {
      $('#hugrid').css('left', pageleftmargin + pageMarUnits);
      $('#hugrid').css('margin', '0');
    } else if (typeof window.pagerightmargin === 'number') {
      $('#hugrid').css('right', pagerightmargin + pageMarUnits);
      ...
      if (pageUnits === '%') {
        ...
        $('#hugrid').css('margin-left', '-' + ((pagewidth / 2) - (gutterwidth / 2)) + pageUnits);
      }
    }

    $('#hugrid div.hugcol').css('margin-left', columnwidth + colUnits);
    $('#hugrid div.hugcol').css('width', gutterwidth + gutUnits);
